...
import com.userplay.bazar22.databinding.FragmentKingStarHistoryBinding
...
@AndroidEntryPoint
class KingStarHistoryFragment : Fragment(R.layout.fragment_king_star_history),
    View.OnClickListener {
    @Inject
    lateinit var mPref: MatkaPref
    private var _binding: FragmentKingStarHistoryBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentKingStarHistoryBinding.inflate(inflater, container, false)
