...
import com.userplay.bazar22.databinding.FragmentTriplePanaBinding
...
@AndroidEntryPoint
class TriplePanaFragment : Fragment(R.layout.fragment_triple_pana), View.OnClickListener,
    OnGameTypeListener {

    @Inject
    lateinit var mPref: MatkaPref
    private var _binding: FragmentTriplePanaBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTriplePanaBinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        mBinding.apply {
            gameType.setOnClickListener(this@TriplePanaFragment)
            tvGameType.setOnClickListener(this@TriplePanaFragment)
            add.setOnClickListener(this@TriplePanaFragment)
            finalSubmit.setOnClickListener(this@TriplePanaFragment)
            back.setOnClickListener(this@TriplePanaFragment)
                ...
                when (v?.id) {
                    ...
                    R.id.add -> {
                        if (edNumber.text.length != 3) {
                            ...
                            edNumber.error = "Enter Valid Pana"
                            return@let
                        } else if (!edNumber.text.toString().toInt().triplePana()) {
                            edNumber.error = "Enter Valid Pana"
                            return@let
