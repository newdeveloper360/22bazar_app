...
import com.userplay.bazar22.databinding.FragmentJodiDigitsNewBinding
...
@AndroidEntryPoint
class JodiDigitsNewFragment : Fragment(R.layout.fragment_jodi_digits_new), OnGameTypeListener {
    private var _binding: FragmentJodiDigitsNewBinding? = null
    ...
    private val mArgs: JodiDigitsNewFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJodiDigitsNewBinding.inflate(inflater, container, false)
    ...
    fun updatePairs(number:Int){
        mAdapterPair?.updateList(number.jodiDigitsPairs())
    }
    var lastSelected=0
    fun refreshAdapter(){
