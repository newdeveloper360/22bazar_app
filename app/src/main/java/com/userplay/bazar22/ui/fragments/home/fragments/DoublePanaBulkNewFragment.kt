...
import com.userplay.bazar22.databinding.FragmentDoublePanaBulkNewBinding
...
import com.userplay.bazar22.utils.doublePanaBulkPairs
import dagger.hilt.android.AndroidEntryPoint
import javax.inject.Inject


@AndroidEntryPoint
class DoublePanaBulkNewFragment : Fragment(R.layout.fragment_double_pana_bulk_new), OnGameTypeListener {
    private var _binding: FragmentDoublePanaBulkNewBinding? = null
    ...
    private val mArgs: DoublePanaBulkNewFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDoublePanaBulkNewBinding.inflate(inflater, container, false)
        return mBinding.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        listPairNumbers=0.doublePanaBulkPairs()
        initViews()
        observer()
    }
    ...
    fun updatePairs(number:Int){
        mAdapterPair?.addList(number.doublePanaBulkPairs())
    }
    var lastSelected=0
    fun refreshAdapter(){
