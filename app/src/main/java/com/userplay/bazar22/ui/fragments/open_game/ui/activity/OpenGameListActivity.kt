...
import com.userplay.bazar22.databinding.ActivityOpenGameListBinding
...
@AndroidEntryPoint
class OpenGameListActivity : AppCompatActivity(), OnGameListener {

    @Inject
    lateinit var mPref: MatkaPref
    private lateinit var mBinding: ActivityOpenGameListBinding
    ...
    private val mMarketAdapter by lazy { MarketAdapter(mMarketsList, this,0,"market") }

    override fun onCreate(savedInstanceState: Bundle?, persistentState: PersistableBundle?) {
        super.onCreate(savedInstanceState, persistentState)
        mBinding = ActivityOpenGameListBinding.inflate(layoutInflater)
    ...
    private fun initView() {
        mBinding.rvGames.apply {
            layoutManager =
                LinearLayoutManager(this@OpenGameListActivity, RecyclerView.VERTICAL, false)
    ...
    override fun onGameClosedClick(
        ...
        //        showToast("me called")
//        val dialog = BidClosedDialogFragment()
