...
import com.userplay.bazar22.databinding.FragmentFullSangamNewBinding
...
@AndroidEntryPoint
class FullSangamNewFragment : Fragment(R.layout.fragment_full_sangam_new), View.OnClickListener,
    OnGameTypeListener {
    @Inject
    lateinit var mPref: MatkaPref

    private var _binding: FragmentFullSangamNewBinding? = null
    ...
    private val mArgs: FullSangamNewFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFullSangamNewBinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        mBinding.apply {
            btnAdd.setOnClickListener(this@FullSangamNewFragment)
            finalSubmit.setOnClickListener(this@FullSangamNewFragment)
            back.setOnClickListener(this@FullSangamNewFragment)
