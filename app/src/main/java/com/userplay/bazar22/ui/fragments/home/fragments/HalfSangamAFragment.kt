...
import com.userplay.bazar22.databinding.FragmentHalfSangamABinding
...
@AndroidEntryPoint
class HalfSangamAFragment : Fragment(R.layout.fragment_half_sangam_a), View.OnClickListener,
    OnGameTypeListener {

    @Inject
    lateinit var mPref: MatkaPref

    private var _binding: FragmentHalfSangamABinding? = null
    private val mBinding get() = _binding!!
    private var mTotalPoints: Int = 0
    private lateinit var mSendBody: SendBody
    private val mArgs: HalfSangamAFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHalfSangamABinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        mBinding.apply {
            add.setOnClickListener(this@HalfSangamAFragment)
            finalSubmit.setOnClickListener(this@HalfSangamAFragment)
            back.setOnClickListener(this@HalfSangamAFragment)
