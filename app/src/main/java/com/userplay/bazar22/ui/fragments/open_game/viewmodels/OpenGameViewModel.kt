package com.userplay.bazar22.ui.fragments.open_game.viewmodels
...
@HiltViewModel
class OpenGameViewModel @Inject constructor(
    ...
    fun getDesawarMarket() {
        ...
        viewModelScope.launch {
            try {
                val response = mApiInterface.getMarket(DESAWAR_MARKET)
