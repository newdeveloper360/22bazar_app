...
import com.userplay.bazar22.databinding.FragmentSinglePanaBinding
...
@AndroidEntryPoint
class SinglePanaFragment : Fragment(R.layout.fragment_single_pana), View.OnClickListener,
    OnGameTypeListener {


    @Inject
    lateinit var mPref: MatkaPref
    private var _binding: FragmentSinglePanaBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSinglePanaBinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        mBinding.apply {
            gameType.setOnClickListener(this@SinglePanaFragment)
            tvGameType.setOnClickListener(this@SinglePanaFragment)
            add.setOnClickListener(this@SinglePanaFragment)
            finalSubmit.setOnClickListener(this@SinglePanaFragment)
            back.setOnClickListener(this@SinglePanaFragment)
