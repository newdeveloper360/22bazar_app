...
import com.userplay.bazar22.databinding.FragmentSinglePannaNewBinding
...
@AndroidEntryPoint
class SinglePannaNewFragment : Fragment(R.layout.fragment_single_panna_new), OnGameTypeListener  {
    private var _binding: FragmentSinglePannaNewBinding? = null
    ...
    private val mArgs: SinglePannaNewFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentSinglePannaNewBinding.inflate(inflater, container, false)
    ...
    fun updatePairs(number:Int){
        mAdapterPair?.updateList(number.singlePanaPairs())
    }
    var lastSelected=0
    fun refreshAdapter(){
