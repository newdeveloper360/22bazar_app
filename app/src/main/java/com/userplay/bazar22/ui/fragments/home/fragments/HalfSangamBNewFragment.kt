...
import com.userplay.bazar22.databinding.FragmentHalfSangamBNewBinding
...
@AndroidEntryPoint
class HalfSangamBNewFragment : Fragment(R.layout.fragment_half_sangam_b_new), View.OnClickListener,
    OnGameTypeListener {

    @Inject
    lateinit var mPref: MatkaPref

    private var _binding: FragmentHalfSangamBNewBinding? = null
    ...
    private val mArgs: HalfSangamBNewFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHalfSangamBNewBinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        mBinding.apply {
            btnAdd.setOnClickListener(this@HalfSangamBNewFragment)
            finalSubmit.setOnClickListener(this@HalfSangamBNewFragment)
            back.setOnClickListener(this@HalfSangamBNewFragment)
            edClose.filters = arrayOf<InputFilter>(
                ...
                when (v?.id) {
                    ...
                    R.id.btnAdd -> {
                        if (edOpenPana.text.isNullOrEmpty()) {
                            ...
                            edOpenPana.error = " Enter valid pana"
                            return@let
                        } else if (edClose.text.isNullOrEmpty()) {
                            edClose.error = "Please enter close digit"
                            return@let
                            ...
                            mOriginalList.add(
                                Game(
                                    ...
                                    edOpenPana.text.toString().trim() + edClose.text.toString()
                                        .trim(),
                            ...
                            mGamesList.add(
                                Game(
                                    ...
                                    edOpenPana.text.toString()
                                        .trim() + "-" + edClose.text.toString().trim(),
                                    mPref.getSessionType(Constants.SESSION_TYPE),
                                    gameTypeId = 7
                                )
                            )
                    ...
                    R.id.final_submit -> {
                        ...
                        if (mGamesList.size == 0) {
                            ...
                            val action =
                                HalfSangamBNewFragmentDirections.actionGlobalSubmitGameDialogFragment(
