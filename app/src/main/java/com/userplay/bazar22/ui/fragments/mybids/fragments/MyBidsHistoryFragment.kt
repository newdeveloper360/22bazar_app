...
import com.userplay.bazar22.databinding.FragmentMyBidsHistoryBinding
...
@AndroidEntryPoint
class MyBidsHistoryFragment : Fragment(R.layout.fragment_my_bids_history), View.OnClickListener {

    private var _binding: FragmentMyBidsHistoryBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMyBidsHistoryBinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        mBinding.apply {
            back.setOnClickListener(this@MyBidsHistoryFragment)
            btnNext.setOnClickListener(this@MyBidsHistoryFragment)
            btnPrevious.setOnClickListener(this@MyBidsHistoryFragment)
        ...
        activity?.let {
            ...
            if (CheckNetwork.isNetworkConnected) {
                mMyBidsViewModels.getGameHistory(GENERAL_MARKET, mCurrentPageNumber)
            } else {
