...
import com.userplay.bazar22.databinding.FragmentStarLineResultHistoryBinding
...
@AndroidEntryPoint
class StarLineResultHistoryFragment : Fragment(R.layout.fragment_star_line_result_history),
    View.OnClickListener {

    @Inject
    lateinit var mPref: MatkaPref
    private var _binding: FragmentStarLineResultHistoryBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentStarLineResultHistoryBinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        if (CheckNetwork.isNetworkConnected) {
            mMyBidsViewModels.getGameResult(STARLINE_MARKET, currentDate)
        } else {
