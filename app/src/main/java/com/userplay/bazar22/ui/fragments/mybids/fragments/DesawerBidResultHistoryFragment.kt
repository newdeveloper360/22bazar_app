...
import com.userplay.bazar22.databinding.FragmentDesawerBidResultHistoryBinding
...
@AndroidEntryPoint
class DesawerBidResultHistoryFragment : Fragment(R.layout.fragment_desawer_bid_result_history),View.OnClickListener {

    @Inject
    lateinit var mPref : MatkaPref
    private var _binding: FragmentDesawerBidResultHistoryBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDesawerBidResultHistoryBinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        if (CheckNetwork.isNetworkConnected) {
            mMyBidsViewModels.getGameResult(DESAWAR_MARKET, currentDate)
        } else {
