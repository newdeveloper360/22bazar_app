...
import com.userplay.bazar22.databinding.FragmentDoublePanaBinding
...
import com.userplay.bazar22.utils.Constants.DOUBLE_PANA_GAME_TYPE
import com.userplay.bazar22.utils.isDoublePana
import dagger.hilt.android.AndroidEntryPoint
import javax.inject.Inject

@AndroidEntryPoint
class DoublePanaFragment : Fragment(R.layout.fragment_double_pana), View.OnClickListener,
    OnGameTypeListener {

    @Inject
    lateinit var mPref: MatkaPref

    private var _binding: FragmentDoublePanaBinding? = null
    ...
    private val mArgs: DoublePanaFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDoublePanaBinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        mBinding.apply {
            gameType.setOnClickListener(this@DoublePanaFragment)
            tvGameType.setOnClickListener(this@DoublePanaFragment)
            add.setOnClickListener(this@DoublePanaFragment)
            finalSubmit.setOnClickListener(this@DoublePanaFragment)
            back.setOnClickListener(this@DoublePanaFragment)
                ...
                when (v?.id) {
                    ...
                    R.id.add -> {
                        if (edNumber.text.length != 3) {
                            edNumber.error = "Enter Valid Pana"
                            return@let
