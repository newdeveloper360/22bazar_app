...
import com.userplay.bazar22.databinding.FragmentDoublePannaNewBinding
...
@AndroidEntryPoint
class DoublePannaNewFragment : Fragment(R.layout.fragment_double_panna_new), OnGameTypeListener  {
    private var _binding: FragmentDoublePannaNewBinding? = null
    ...
    private val mArgs: DoublePannaNewFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDoublePannaNewBinding.inflate(inflater, container, false)
    ...
    fun updatePairs(number:Int){
        mAdapterPair?.updateList(number.doublePanaBulkPairs())
    }
    var lastSelected=0
    fun refreshAdapter(){
