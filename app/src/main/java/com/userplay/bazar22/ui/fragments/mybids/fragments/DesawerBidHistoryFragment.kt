...
import com.userplay.bazar22.databinding.FragmentDesawerBidHistroyBinding
...
@AndroidEntryPoint
class DesawerBidHistoryFragment : Fragment(R.layout.fragment_desawer_bid_histroy),
    View.OnClickListener {

    private var _binding: FragmentDesawerBidHistroyBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDesawerBidHistroyBinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        mBinding.apply {
            back.setOnClickListener(this@DesawerBidHistoryFragment)
            btnNext.setOnClickListener(this@DesawerBidHistoryFragment)
            btnPrevious.setOnClickListener(this@DesawerBidHistoryFragment)
        ...
        activity?.let {
            ...
            if (CheckNetwork.isNetworkConnected) {
                mMyBidsViewModels.getGameHistory(DESAWAR_MARKET, mCurrentPageNumber)
            } else {
