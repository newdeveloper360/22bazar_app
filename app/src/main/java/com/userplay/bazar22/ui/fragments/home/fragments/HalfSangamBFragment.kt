...
import com.userplay.bazar22.databinding.FragmentHalfSangamBBinding
...
@AndroidEntryPoint
class HalfSangamBFragment : Fragment(R.layout.fragment_half_sangam_b), View.OnClickListener,
    OnGameTypeListener {

    @Inject
    lateinit var mPref: MatkaPref

    private var _binding: FragmentHalfSangamBBinding? = null
    ...
    private val mArgs: HalfSangamBFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHalfSangamBBinding.inflate(inflater, container, false)
    ...
    private fun initView() {
        ...
        mBinding.apply {
            add.setOnClickListener(this@HalfSangamBFragment)
            finalSubmit.setOnClickListener(this@HalfSangamBFragment)
            back.setOnClickListener(this@HalfSangamBFragment)
                ...
                when (v?.id) {
                    ...
                    R.id.final_submit -> {
                        ...
                        if (mGamesList.size == 0) {
                            ...
                            val action =
                                HalfSangamBFragmentDirections.actionGlobalSubmitGameDialogFragment(
