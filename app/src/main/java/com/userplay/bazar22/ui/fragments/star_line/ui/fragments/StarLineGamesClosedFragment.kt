...
@AndroidEntryPoint
class StarLineGamesClosedFragment : DialogFragment(R.layout.fragment_deshawar_games_closed),
    ...
    private fun initView() {
        ...
        mBinding.apply {
            okDialogBox.setOnClickListener(this@StarLineGamesClosedFragment)
